  ...
  private
    ...
    def training_params
      params.require(:training).permit(
        :name, :info, :moreinfo, :target, :methods, :groupsize, :trainer_info, :studies, :postgrad, :elearning, :paid, :costs, :costs_info, :term, :term_info, :term_notes, :begin_date, :end_date,:address, :organizer_id, :location_id, :category_id, organizer_attributes: [:name, :address, :contact, :link, :college], trainer_ids: [] )
    end
end
